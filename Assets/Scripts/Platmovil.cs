...
public class Platmovil : MonoBehaviour
{
    ...
    {
        if (target != null)
        { //Verificamos si target es distinto de vacio
    ...
    {
        if (target != null)
        {// Si el target no está vacio, hace lo que esta entre las llaves
        ...
        { //Verificamos que la plataforma movil llegó a la posicion del target
